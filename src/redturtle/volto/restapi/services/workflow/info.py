...
from plone.restapi.services.workflow.info import WorkflowInfo as BaseInfo
...
@adapter(IWorkflowAware, IRedturtleVoltoLayer)
class WorkflowInfo(BaseInfo):
    def __call__(self, expand=False):
        ...
        current_state_title = wftool.getTitleForStateOnType(
            current_state, self.context.portal_type,
        )
